...
class IntentService():
    ...
    def create_intent(self,data:CreateIntentJobsRequest) -> CreateIntentJobsResponse:
        try:
            ...
            schedule_expression = intent_data.get("schedule_expression", APP_CONSTANTS.DEFAULT_SCHEDULE_EXP)
            next_run_at = compute_timestamp_from_cron(cron_expression=schedule_expression)
